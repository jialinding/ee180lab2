# Set compiler args
CC=g++
CFLAGS=-Wall -mfpu=neon -O3 -ftree-vectorize -ftree-vectorizer-verbose=1 -fopt-info-vec-missed=missed -fopt-info-vec-optimized=optimized -funsafe-math-optimizations -c
LDFLAGS=
